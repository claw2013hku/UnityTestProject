...
public class ThirdPersonTouchController : MonoBehaviour {
...
//			}
	...
	{
		return Mathf.Abs(ControlSchemeInterface.instance.GetAxis(ControlAxis.MOVE_Y) + Input.GetAxisRaw("Vertical")) + Mathf.Abs(ControlSchemeInterface.instance.GetAxis(ControlAxis.MOVE_X) + Input.GetAxisRaw("Horizontal")) > 0.5f;
	}
