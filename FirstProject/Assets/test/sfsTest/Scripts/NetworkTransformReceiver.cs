...
public class NetworkTransformReceiver : MonoBehaviour {
	...
	private SFSNetworkCharacterTest interpolator;
//	private AnimationSynchronizer animator;
	
	void Awake() {
		thisTransform = this.transform;
//		animator = GetComponent<AnimationSynchronizer>();
		interpolator = GetComponent<SFSNetworkCharacterTest>();
	...
	public void ReceiveAttackMove(){
		interpolator = GetComponent<SFSNetworkCharacterTest>();
		interpolator.attackPending = true;	
	}
